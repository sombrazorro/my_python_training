...
import ex18_sort_performance
from random import randint

parser = argparse.ArgumentParser(prog='ex18_sort_performance_test.py')
...
def test_bubble_sort():
    ...
    m = numbers.count()
    ex18_sort_performance.bubble_sort(numbers)
...
def test_merge_sort():
   ...
   # numbers = random_list(max_numbers * 1000)
    ...
    ex18_sort_performance.merge_sort(numbers)
    assert numbers.count() == m
    assert is_sorted(numbers)
...
def test_quick_sort_copy():
    ...
    m = numbers.count()
#    print(numbers.dump())
   # ex18_sort_performance.quick_sort(numbers, 0, numbers.count() - 1)
    r = ex18_sort_performance.quick_sort_copy(numbers)
...
def test_quick_sort():
   ...
   # numbers = random_list(max_numbers * 1000)
    ...
    print(m)
   # ex18_sort_performance.quick_sort(numbers, 0, numbers.count() - 1)
    ex18_sort_performance.quick_sort(numbers)
    assert numbers.count() == m
    assert is_sorted(numbers)
